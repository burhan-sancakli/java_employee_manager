...
public class Employee
{
    ...
    public Employee(int id, String surname, String name, int number_of_hours, double hourly_rate, int birth_day, int birth_month, int birth_year, int job_day, int job_month, int job_year){
    ...
    private static String toJson(ArrayList<Employee> employees){
        ...
        for (Employee employee : employees) 
        {
            if(!isFirst) { json += ","; }
            isFirst = false;
            json +="{\"id\":"+employee.id+", \"surname\":\""+employee.surname+"\", \"name\":\""+employee.name+"\", \"number_of_hours\":"+employee.number_of_hours+", \"hourly_rate\":\""+employee.hourly_rate+"\", \"birth_day\":"+employee.birth_day+", \"birth_month\":"+employee.birth_month+", \"birth_year\":"+employee.birth_year+", \"job_day\":"+employee.job_day+", \"job_month\":"+employee.job_month+", \"job_year\":"+employee.job_year+", \"value_of_work_done\":\""+employee.value_of_work_done+"\"}";
        }
        json += "]";
        return json;
    }
